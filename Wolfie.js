...
client.on('message', async message => {
   ...
   if (message.content === prefix + 'serverinfo') {
     ...
     .addField('Your ID', author.id, true)
     .addField('Discord Server Created In', message.author.createdAt.toDateString(), true)
     .addField('You Join at', author.joinedAt.toDateString(), true)
     .addField('Are you a Bot?', message.author.bot ? 'Yes' : 'No', true)
     .addField('Are You Nick?', author.nickname || 'None', true)
     .setFooter(`Requested by ${message.author.tag}`)
